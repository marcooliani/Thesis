...
class MergeDatasets:
    ...
    def __init__(self):
        ...
        parser.add_argument('-g', "--granularity", type=int, default=int(self.config['DEFAULTS']['granularity']),
                            help="choose granularity in seconds (for slopes)")
        parser.add_argument('-s', "--skiprows", type=int, default=int(self.config['DEFAULTS']['skip_rows']),
                            help="skip seconds from start")
        parser.add_argument('-n', "--nrows", type=int, default=int(self.config['DEFAULTS']['number_of_rows']),
