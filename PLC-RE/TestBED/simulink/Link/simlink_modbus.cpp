//Script to connect the simulink model to the docker containers
//Original author https://github.com/thiagoralves/OpenPLC_Simulink-Interface
//Modified in order to work with the docker containers
