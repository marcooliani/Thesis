...
\bigskip
{\small
\begin{longtable}[c]{p{0.30\textwidth} p{0.62\textwidth}}
	\hline
	\textbf{Phase} & \textbf{Limitations} \\ [0.5ex] 
	\hline
	Testbed & - Oversimplified model compared other testbeds \newline
	- Physics of the liquid not considered: this causes data perturbation. \\
	\hline
	Pre-processing & - It is not possible to select a subsystem by (groups of) PLCs or by time range \newline
	- Some additional attributes are manually inserted into dataset.\\
	\hline
	Graphical/Statistical\newline Analysis & - Only one chart at the time is displayed: difficulty in capturing the relationship between actuators and sensors. \newline
	- Statistical Analysis provides little information \\
	\hline
	Business Process\newline Analysis & - Ad hoc solution designed to work under special conditions\newline
	- Use of commercial software for process mining\\
	\hline
	Invariant Analysis & - Reading output is challenging\newline
	- Script for analysis merely launches Daikon without reprocessing outcomes\\
	\hline
